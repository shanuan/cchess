...
var ST1='font-size:12px;font-family:\u5B8B\u4F53,MS Song;line-height:16px;';
function DrawEdit()
{
	var ST0=ST1+'height:'+(CSS1?16:20)+'px;';
	var S=('<div style="'+ST1+'margin:3px"><button type="button" style="'+ST0+'width:72px;height:20px;" onclick="save(\'u\');">\u4FDD\u5B58\u68CB\u8C31</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="preview();">\u9884\u89C8</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="document.formSave.reset();">\u91CD\u7F6E</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="Delete(250)">\u5220\u9664</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="Delete(88)">\u4E22\u5F03</button>\u3000<button type="button" style="'+ST0+'width:124px;height:20px;" onclick="save(\'m\');">\u4FDD\u5B58\u5230\u5927\u5E08\u5BF9\u5C40</button></div>');
	S+=('<div style="'+ST0+'width:448px;height:52px;margin-left:3px;position:relative;"><textarea style="position:absolute;left:0;top:0;width:'+(CSS1?445:448)+'px;height:52px;overflow:hidden;"></textarea>');
	S+=('<div style="'+ST0+'padding:3px 0 0 12px;position:absolute;top:0;left:0;color:#00f;">\u6CE8\u610F\uFF1A\u60A8\u76EE\u524D\u53EF\u4EE5\u9009\u62E9\u5C06\u6700\u65B0<span style="'+ST1+'color:#f00">\u8C61\u68CB\u5927\u8D5B</span>\u6216<span style="'+ST1+'color:#f00">\u540D\u624B\u4E4B\u95F4</span>\u5BF9\u5C40\u68CB\u8C31\u5F55\u5165\u5230\u5927\u5E08\u5BF9\u5C40\u5E93<br>');
	S+=('\u5982\u8981\u5C06\u68CB\u8C31<a href="javascript:save(\'m\')" style="'+ST1+'color:#f00">\u4FDD\u5B58\u5230\u5927\u5E08\u5BF9\u5C40</a>\uFF0C\u8BF7<span style="'+ST1+'color:#f00">\u8BA4\u771F\u8F93\u5165</span>\u5404\u9879\u6570\u636E\uFF0C\u70B9\u680F\u76EE\u5DE6\u4FA7\u6807\u9898\u6587\u5B57\u53EF\u4EE5<br>');
	S+=('<a href="javascript:g_hide(\'fastlink.htm#\')" style="'+ST1+'color:#f00">\u5FEB\u901F\u5F55\u5165</a>\u9884\u8BBE\u503C\u3002\u70B9<a href="javascript:g_tour()" style="'+ST1+'color:#f00">\u67E5\u5BF9\u9635</a>\u53EF\u6839\u636E\u67E5\u5230\u7684\u5BF9\u9635\u8BBE\u7F6E\u68CB\u8C31\u6570\u636E<span style="color:#f00;">\u6781\u5927\u63D0\u9AD8\u5F55\u8C31\u901F\u5EA6</span></div></div>');
	S+=('<form name="formSave" id="formSave" style="margin:3px;'+ST1+(CSS1?'line-height:24px;':'')+'" method="post" action="save.asp">');
	...
	S+=('<br><a href="javascript:checkError(\'movelist\')">\u7740\u6CD5\u5E8F\u5217</a>\uFF1A<textarea ondblclick="this.select()" style="'+ST0+'width:'+(CSS1?385:388)+'px;height:88px;overflow-y:scroll;overflow-x:hidden;" name="DhtmlXQ_movelist"></textarea>');
	S+=('<br><a href="javascript:checkError(\'comment\')">\u68CB\u8C31\u6CE8\u89E3</a>\uFF1A<textarea ondblclick="this.select()" style="'+ST0+'width:'+(CSS1?385:388)+'px;height:88px;overflow-y:scroll;overflow-x:hidden;" name="DhtmlXQ_comment"></textarea></form>');
	S+=('<div style="'+ST1+'margin:3px"><button type="button" id="mySaveB" style="'+ST0+'width:72px;height:20px;" onclick="save(\'\');">\u4FDD\u5B58\u68CB\u8C31</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="preview();">\u9884\u89C8</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="document.formSave.reset();">\u91CD\u7F6E</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="Delete(250)">\u5220\u9664</button>\u3000<button type="button" style="'+ST0+'width:48px;height:20px;" onclick="Delete(88)">\u4E22\u5F03</button>\u3000<button type="button" style="'+ST0+'width:124px;height:20px;" onclick="checkError()">\u68C0\u67E5\u7740\u6CD5\u548C\u6CE8\u89E3</button></div>');
	var w=388,h=108,b=4;
	if (NS.IE&&NS.IE<=6) framePrev='<iframe src="" style="width:'+w+'px;height:'+h+'px;position:absolute;top:0;left:0;border:0;"></iframe>';
	S+=('<div id="prevd0" style="width:'+w+'px;height:'+h+'px;margin-left:63px;position:absolute;background-color:#fff;"><div id="prevIE6" style="width:'+w+'px;height:'+h+'px;position:absolute;top:0;left:0;overflow:hidden;"></div><textarea style="width:'+(w-(CSS1?3:0))+'px;height:'+h+'px;position:absolute;top:0;left:0;overflow:hidden;"></textarea><div style="position:absolute;top:'+b+'px;left:'+b+'px;height:'+(h-b*2)+'px;width:'+(w-b*2)+'px;overflow-x:hidden;">');
	for (var i=1;i<=5;i++) S+=('<div id="prevd'+i+'" style="'+ST1+'white-space:nowrap;"></div>');
	S+=('<div style="position:absolute;width:'+(w-b*2)+'px;left:0;top:82px;text-align:right;"><a href="javascript:GetTuiYanData()" style="color:#00F">\u83B7\u53D6\u63A8\u6F14\u68CB\u76D8\u5404\u9879\u6570\u636E</a> <a href="javascript:SetDataPrev(0,0)" style="color:#00F">\u6E05\u7A7A\u672C\u680F\u6570\u636E</a> <a href="javascript:ClosePrev()" style="color:#00F">¡Á\u5173\u95ED</a>&nbsp;</div></div></div>');
	S+=('<div id="helpdiv" style="'+ST0+'width:448px;height:'+(h+3)+'px;margin-left:3px;position:absolute;"><textarea id="helpTEXTAREA" style="position:absolute;left:0;top:0;width:'+(CSS1?445:448)+'px;height:'+h+'px;overflow:auto;"></textarea><div></div></div>');
...
{
	if (t!=1) return '<a href="javascript:SelectPrev(\''+s+'\',1)">\u2193</a>';
	...
	for (i=l;i>=0;i--)
	{
		...
		{
			document.getElementById('prevd'+j).innerHTML='<a href="javascript:SetDataPrev(\''+s+'\','+j+')" style="display:block;background-color:#fff;" title="'+ss+'">'+ss+'</a>';
			s0=ss;
			j++;
			if (j>5) i=-1;
		}
