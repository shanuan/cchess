...
var FF=(!isBIG5)?'font-family:\u5B8B\u9AD4,\u65B0\u5B8B\u9AD4,SimSun,NSimSun,\'MS Song\';':'font-family:\u7D30\u660E\u9AD4,\u65B0\u7D30\u660E\u9AD4,MingLiU,PMingLiU;';
var S=('<style type="text/css">');
S+=('html {height:100%;}');
S+=('* {font-size:'+fz+'px;line-height:'+lh+'px;margin:0;padding:0;'+FF+'}');
...
S+=('#m_text div,#v_text div {white-space:pre;overflow:hidden;line-height:'+(lh-(NS.IE>0&&NS.IE<9?2:1))+'px;padding-top:'+(NS.IE>0&&NS.IE<9?2:1)+'px;cursor:default;'+(WIN.mobile?'font-family:monospace;':';')+'}');
...
S+=('</style>');
document.write(S+'<div id="message" style="position:absolute;left:'+(wm/10)+'px;top:'+hm+'px;width:'+(wm*0.8)+'px;border:2px solid #0f0;background-color:#f4fcf3;"><div style="margin:2px;color:#00f;text-align:center;height:'+(hm-lh-lh)+'px;width:'+(wm*0.8-4)+'px;overflow:hidden;" id="messdiv">DongPing DhtmlXQ ChessBoard Loading ......<br>Powered By dpxq.com Program Version '+PVer+'</div><div style="margin-bottom:'+(fz/2)+'px;text-align:center;width:100%;"><button style="width:'+(fz*5)+'px;padding-top:2px;margin-right:20%;" onclick="clickYES()">\u78BA \u5B9A</button><button style="width:'+(fz*5)+'px;padding-top:2px;" onclick="clickNO()">\u53D6 \u6D88</button></div></div><div id="divs" style="overflow:hidden;"></div><div id="divsave" style="display:none;overflow:auto;"></div>');
...
function initboard()
{
	...
	s+=('</div>');
	s+=cDIV(6,thh+ch+1,w3-7,'',0,typ,'','<span id="livevartxt">\u8B8A\u8457(\u55AE\u64CA\u9078\u64C7)</span>\u3000<a href="javascript:UpMove()" title="\u63D0\u5347\u7576\u524D\u8B8A\u8457">\u5347</a><a href="javascript:DownMove()" title="\u964D\u4F4E\u7576\u524D\u8B8A\u8457">\u964D</a><a href="javascript:DelMove()" title="\u522A\u9664\u672C\u6B65\u5F8C\u8457\u6CD5\u6216\u5B50\u8B8A\u8457\u6A39">\u522A</a>');
	...
	s+=cDIV(6,thh+ch+1,w4-7,'',0,typ,'','<a href="javascript:void(0)" onclick="copycode(sText)" style="color:#f00">\u8907\u88FD\u4EE3\u78BC</a> <a href="javascript:setBinit(1)">\u5C07\u5DE6\u5074\u5C40\u9762\u8A2D\u7232\u958B\u59CB</a> <a href="javascript:setBinit(2)" style="color:#f00">\u6E05\u7A7A\u68CB\u76E4</a> <a href="javascript:setBinit(3)">\u65B0\u5C40</a>');
	...
	s+=cDIV(6,1,w4-7,'',0,'padding-top:1px!important;padding-top:2px;line-height:'+(thh-2)+'px;','','\u68CB\u8B5C\u641C\u7D22');
